# DukonPro Play Market Release — Full Spec
...
- Bot flow:
  ...
  3. Confirmation: "Your number +992XXXXXXXXX is linked to DukonPro"
...
**Firebase setup:**
- Create Firebase project "DukonPro"
...
4. Build: `flutter build appbundle --dart-define=API_BASE_URL=https://api.dukonpro.tj`
