Создай веб-страницу (Desktop, 1440x900px) для входа в админ-панель платформы "DukonPro Admin". Стиль: современный, чистый, профессиональный. Центрированная форма.
...
- По центру экрана — белая карточка (420px ширина, padding 40px, радиус 16px, тень 0 8px 32px rgba(0,0,0,0.2)):
  - Логотип "DukonPro" (бирюзовый, 32px Bold) + текст "Admin Panel" (16px, серый #64748B) — по центру
  - Отступ 32px
...
- Под карточкой: "DukonPro Admin v1.0" (12px, белый opacity 50%) + "© 2026 ITL Solutions" (12px, белый opacity 30%)
