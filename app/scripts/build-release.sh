...
# DukonPro Release Build Script
# Usage: ./scripts/build-release.sh https://api.dukonpro.tj

API_URL="${1:-https://api.dukonpro.tj}"

echo "=== DukonPro Release Build ==="
...
echo "  2. Select 'DukonPro' app (or create new)"
