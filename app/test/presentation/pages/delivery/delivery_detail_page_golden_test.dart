...
import 'package:dokonpro/presentation/pages/delivery/delivery_detail_page.dart';
...
// ── Fake DioClient — always throws so page renders loading/error state ────────
...
void main() {
  ...
  Widget page() => const DeliveryDetailPage(
        storeId: 'test-store-id',
        deliveryId: 'test-delivery-id',
      );

  group('DeliveryDetailPage goldens', () {
    testGoldens('light theme – loading/error state', (tester) async {
      ...
      await screenMatchesGolden(tester, 'delivery_detail_light');
    });
    ...
    testGoldens('dark theme – loading/error state', (tester) async {
      ...
      tester.takeException();
      await screenMatchesGolden(tester, 'delivery_detail_dark');
    });
  });
}
