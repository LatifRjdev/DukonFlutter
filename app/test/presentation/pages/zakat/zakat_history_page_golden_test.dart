...
import 'package:dukonpro/presentation/pages/zakat/zakat_history_page.dart';
...
void main() {
  ...
  Widget page() => const ZakatHistoryPage(storeId: 'test-store-id');
  ...
  group('ZakatHistoryPage goldens', () {
    testGoldens('light theme', (tester) async {
      ...
      await screenMatchesGolden(tester, 'zakat_history_light');
    });
    ...
    testGoldens('dark theme', (tester) async {
      ...
      tester.takeException();
      await screenMatchesGolden(tester, 'zakat_history_dark');
    });
  });
}
