...
import 'package:dukonpro/presentation/pages/debt/supplier_debts_page.dart';
...
void main() {
  ...
  Widget page() => const SupplierDebtsPage(
  ...
  group('SupplierDebtsPage goldens', () {
    testGoldens('light theme', (tester) async {
      ...
      await screenMatchesGolden(tester, 'supplier_debts_light');
    });
    ...
    testGoldens('dark theme', (tester) async {
      ...
      tester.takeException();
      await screenMatchesGolden(tester, 'supplier_debts_dark');
    });
  });
}
