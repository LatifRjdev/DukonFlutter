...
import 'package:dokonpro/presentation/pages/auth/forgot_password_page.dart';
...
void main() {
  ...
  Widget page() => const ForgotPasswordPage();
  ...
  group('ForgotPasswordPage goldens', () {
    testGoldens('light theme', (tester) async {
      ...
      await screenMatchesGolden(tester, 'forgot_password_light');
    });
    ...
    testGoldens('dark theme', (tester) async {
      ...
      tester.takeException();
      await screenMatchesGolden(tester, 'forgot_password_dark');
    });
  });
}
