...
import 'package:dokonpro/presentation/pages/finance/balance_page.dart';
...
void main() {
  ...
  group('BalancePage goldens', () {
    testGoldens('light theme', (tester) async {
      ...
      await screenMatchesGolden(tester, 'balance_light');
    });
    ...
    testGoldens('dark theme', (tester) async {
      ...
      tester.takeException();
      await screenMatchesGolden(tester, 'balance_dark');
    });
  });
}
