...
import 'package:dokonpro/presentation/pages/finance/currencies_page.dart';
...
void main() {
  ...
  // CurrenciesPage has no required storeId — construct directly.
  Widget page() => const CurrenciesPage();

  group('CurrenciesPage goldens', () {
    testGoldens('light theme', (tester) async {
      ...
      await screenMatchesGolden(tester, 'currencies_light');
    });
    ...
    testGoldens('dark theme', (tester) async {
      ...
      tester.takeException();
      await screenMatchesGolden(tester, 'currencies_dark');
    });
  });
}
