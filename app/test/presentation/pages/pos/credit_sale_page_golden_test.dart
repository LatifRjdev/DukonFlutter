...
import 'package:dukonpro/presentation/pages/pos/credit_sale_page.dart';
...
void main() {
  ...
  setUp(() {
    ...
    when(() => checkoutBloc.state).thenReturn(
      const CheckoutState(total: 15.0, paymentMethod: 'DEBT'),
    );
  });
  ...
  group('CreditSalePage goldens', () {
    testGoldens('light theme', (tester) async {
      ...
      await screenMatchesGolden(tester, 'credit_sale_light');
    });
    ...
    testGoldens('dark theme', (tester) async {
      ...
      await screenMatchesGolden(tester, 'credit_sale_dark');
    });
  });
}
