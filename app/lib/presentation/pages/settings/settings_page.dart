                  ...
                  if (state is SettingsLoaded) {
                    ...
                    return ListView(
                      ...
                      children: [
                        ...
                        _buildSectionCard([
                          _buildTile(Icons.storefront_outlined, 'Мои магазины', onTap: () {}),
                          _buildDivider(),
                          ...
                          _buildDivider(),
                          _buildTile(Icons.discount_outlined, 'Скидки', onTap: () {}),
                          _buildDivider(),
                          _buildTile(Icons.receipt_long_outlined, 'Шаблоны чеков', onTap: () {}),
                        ]),
                        const SizedBox(height: 20),
                        ...
                        _buildSectionCard([
                          _buildTile(Icons.send_outlined, 'Telegram-бот',
                            badge: 'Подключён', badgeColor: AppColors.success, onTap: () {}),
                          _buildDivider(),
                          _buildTile(Icons.point_of_sale_outlined, 'ККМ / Фискализация', onTap: () {}),
                          _buildDivider(),
                          _buildTile(Icons.print_outlined, 'Принтер чеков',
                            onTap: () => context.push(RouteNames.printerSettings)),
                          _buildDivider(),
                          _buildTile(Icons.qr_code_scanner_outlined, 'Сканер', onTap: () {}),
                        ]),
                        const SizedBox(height: 20),
